...
function Posts() {
  ...
  return (
    <div>
      <NavbarAdmin />
      <div className="mt-24  md:mt-16 lg:mt-18 xl:mt-24 flex justify-center text-2xl font-bold">Posts</div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8 lg:px-10 px-7 mt-5 md:mt-8 lg:mt-6 xl:mt-7">
        {posts.map((post) => (
          <div key={post.id} className="relative flex flex-col text-gray-700 shadow-md rounded-xl bg-clip-border">
            ...
            <div className="relative h-56 overflow-hidden text-white shadow-lg rounded-t-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
              <img src={post.image} alt="img-blur-shadow" className="h-full w-full object-cover rounded-lg" />
            </div>
