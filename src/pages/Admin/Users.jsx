...
function Users() {
  ...
  return (
    <div>
      ...
      <div className="relative overflow-x-auto shadow-md  py-20 dark:bg-gray-900">
        <h4 className="text-white text-center text-2xl p-4 rounded-lg font-semibold tracking-wide bg-gradient-to-r ">
          USERS LIST
        </h4>
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-6 mr-9 py-3">
                Name
              </th>
            ...
            {users.map((user) => (
              ...
              >
                ...
                >
                  ...
                  ></img>
                  <div className="pl-3">
                    <div className="text-base font-semibold px-2">{user.username}</div>
